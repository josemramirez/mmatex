...
\logo{%
    \begin{tikzpicture}
        \node[opacity=0.2] {\includegraphics[width=1cm]{images/citlogogrey.eps}}; % Use absolute path if needed: /home/josem/WEB_JJR/libs/figs/citlogogrey.eps
    \end{tikzpicture}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Este es the pspicture enviroment.. el mas sencillo %%%%%%%%%
...
Un « tren » viaja 1400 centímetros cada 20 horas .
\¿Qué distancia recorre al cabo de 300 segundos ?                                                     
...
$v=\cancelto{70}{\frac{1400}{20}}
\frac{centimetros}{horas}$ \\
...
Es decir, si hay un cent{\'i}metros/horas,
...
\begin{equation}
x=
\left(70\frac{\text{cm}}{\cancel{\text{h}}}\right)
(0.08\cancel{\text{h}})=
5.60~\text{cm}
\end{equation}}
...
La distancia que recorre el tren es
\fbox{5.60 cm}
